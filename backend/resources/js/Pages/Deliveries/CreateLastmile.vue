          ...
          <form @submit.prevent="submit">
            <div class="border border-gray-300 rounded-md overflow-hidden">
              <div class="px-4 py-5 bg-white sm:p-6">
                ...
                <template v-if="user.charge_style == 'PACKAGE'">
                  <div class="mt-6 w-1/4">
                    <span class="block font-medium text-sm text-gray-700">Quantidade de pacotes</span>
                    <jet-input
                      id="packages"
                      min="1"
                      max="99"
                    ...
                    <span class="block text-sm text-gray-500 mt-2 ml-2">
                      Total: {{ $filters.currency($filters.rawCurrency(user.charge_options.price) * form.packages) }} ({{ user.charge_options.price }} por pacote).
                    </span>
                    
                    <jet-input-error
                      :message="form.errors.packages"
                      class="mt-2"
                    />
                  </div>
                </template>
                ...
                <div class="mt-6">
                  <span class="block font-medium text-sm text-gray-700">Observações</span>
                  <textarea
                    id="public_text"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const submit = () => {
      form.post(route("user.request-delivery.store.lastmile"), {
        preserveScroll: true,
      });
    };
