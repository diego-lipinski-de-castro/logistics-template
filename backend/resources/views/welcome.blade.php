    ...
    <body class="font-sans antialiased overflow-x-hidden bg-gray-50">
        ...
        <div class="min-h-full flex flex-col justify-center py-6 sm:px-6 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <h2 class="text-center text-xl font-medium text-gray-800">Agradecemos a parceria de todos que fizeram parte da nossa história!</h2>
            </div>
    
            <div class="mt-6 sm:mx-auto sm:w-full sm:max-w-md">
                <div class="flex flex-col items-center py-8 px-4 sm:px-10">
                    <span class="text-center text-lg text-gray-800 mt-2">Encerramos nossas atividades em 31/03/2022. Dúvidas entre em contato com nosso WhatsApp 47 2106-1904.</span>
                </div>
            </div>
        </div>
    </body>
