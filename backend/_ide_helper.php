 ...
 */
     ...
     */ 
        ...
        {
                        /** @var \Ajthinking\LaravelPostgis\PostgisConnection $instance */
         ...
         *
         * @param \Closure $callback
         * @return \Ajthinking\LaravelPostgis\PostgisConnection 
         * @static 
         */ 
        ...
        {            //Method inherited from \Illuminate\Database\Connection         
                        \Ajthinking\LaravelPostgis\PostgisConnection::resolverFor($driver, $callback);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Database\Connection         
                        return \Ajthinking\LaravelPostgis\PostgisConnection::getResolver($driver);
        }
                    /**
     ...
     */ 
         ...
         * @param string $table
         * @param \Closure $callback
         * @return \Ajthinking\LaravelPostgis\Schema\Blueprint 
         * @static 
         */ 
        public static function createBlueprint($table, $callback = null)
        {
                        /** @var \Ajthinking\LaravelPostgis\Schema\Builder $instance */
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Ajthinking\LaravelPostgis\Schema\Builder::defaultStringLength($length);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Ajthinking\LaravelPostgis\Schema\Builder::defaultMorphKeyType($type);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Ajthinking\LaravelPostgis\Schema\Builder::morphUsingUuids();
        }
                    /**
         ...
         * @return \Ajthinking\LaravelPostgis\Schema\Builder 
         * @static 
         */ 
