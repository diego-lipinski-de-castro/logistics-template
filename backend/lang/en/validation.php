...
return [
    ...
    */
    ...
    'custom' => [
        'street_number' => [
            'required' => 'Preencha um número correto para o endereço. Caso não tenha um número, preencha o mais próximo do endereço.',
            'integer' => 'Preencha um número correto para o endereço. Caso não tenha um número, preencha o mais próximo do endereço.',
        ],
    ],
